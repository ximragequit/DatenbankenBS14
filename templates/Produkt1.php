    ...
    <div class = "card-wrapper">
      <div class = "cards">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "http://localhost/shop/templates/T-Shirt/T-Shirt1.png" alt = "shoe image">
              <img src = "http://localhost/shop/templates/T-Shirt/T-Shirt schwarz hinten Mann.png" alt = "shoe image">
              <img src = "http://localhost/shop/templates/T-Shirt/T-Shirt schwarz Seite Mann.png" alt = "shoe image">
        ...
        <div class = "product-content">
          <h2 class = "product-title">Tshirt Herren Schwarz</h2>
          ...
          <div class = "purchase-info">
            ...
            <a class="btn btn-outline-dark mt-auto" href="index.php/cart/add/1" class="btn btn-success btn-sm">In den Warenkorb</a>
          </div>
